...
class TestStore(unittest.TestCase):
    def test_store_to_csv(self):
        ...
        expected_string = "1652119616.320101,2022-05-09,20:06:56,Echo Dot (4. Generation) | Smarter Lautsprecher mit " \
        ...
        self.assertEqual(expected_string.rstrip(), last_line.rstrip(),

...
class TestItemFactory(unittest.TestCase):
    ...
    def test_create_item(self):
        ...
        self.assertIsNone(product["manufacturer"], "The created item manufacturer does not match the expected output.")
        ...
        expected = 'FLAMMBURO'
        self.assertEqual(expected, product["manufacturer"],
                         "The created item manufacturer does not match the expected output.")

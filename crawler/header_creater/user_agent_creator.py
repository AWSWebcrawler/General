...
def get_user_agent(browser_type):
    ...
    # random_number = 0
    # if browser_type == "iphone":
    #     useragent = iphone_useragents[random_number]
    #     return useragent
    # elif browser_type == "android":
    #     useragent = android_useragents[random_number]
    #     return useragent
    # elif browser_type == "chrome_windows":
    #     useragent = chrome_windows_useragents[random_number]
    #     return useragent
    # elif browser_type == "chrome_macintosh":
    #     useragent = chrome_macintosh_useragents[random_number]
    #     return useragent
    # elif browser_type == "firefox_windows":
    #     useragent = firefox_windows_useragents[random_number]
    #     return useragent
    # elif browser_type == "firefox_macintosh":
    #     useragent = firefox_macintosh_useragents[random_number]
    #     return useragent
    # elif browser_type == "safari":
    #     useragent = safari_useragents[random_number]
    #     return useragent
    # elif browser_type == "linux":
    #     useragent = linux_useragents[random_number]
    #     return useragent
...
#     'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36']
#
# chrome_list = [chrome_windows_useragents, chrome_macintosh_useragents]
#
# firefox_windows_useragents = [
#     'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:99.0) Gecko/20100101 Firefox/99.0',
#     'Mozilla/5.0 (Windows NT 10.0; rv:40.0) Gecko/20100101 Firefox/40.0',
#     'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:38.0) Gecko/20100101 Firefox/38.0',
#     'Mozilla/5.0 (Windows NT 5.1; rv:30.0) Gecko/20100101 Firefox/30.0',
...
#     'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:40.0) Gecko/20100101 Firefox/40.0'
# ]
# firefox_list = [firefox_macintosh_useragents, firefox_macintosh_useragents]
#
# safari_useragents = [
#     'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:99.0) Gecko/20100101 Firefox/99.0',
#     'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_4) AppleWebKit/600.7.12 (KHTML, like Gecko) Version/8.0.7 Safari/600.7.12',
...
# ]
#
# # def load_mobile_iphone():
# #   with open('G:\GitHub\ProjektSS22\UserAgentNew\Iphone_User_Agents.csv', newline='') as f:
# #      reader = csv.reader(f)
...
# # return datalist
#
# # genericlist = load_mobile_iphone()
# # zufall= random.randrange(0, len(genericlist))
#
# # useragent = genericlist[zufall]
# # print(useragent)
